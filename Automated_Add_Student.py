...
driver.find_element(By.XPATH, "/html/body/div/aside/div/div[4]/div/div/nav/ul/li[8]/a/i").click()

for i in range(1, 11):
    driver.find_element(By.XPATH, "/html/body/div/div[1]/section[2]/div/div/div/div/form/div[1]/div[1]/input").clear()
    driver.find_element(By.XPATH, "/html/body/div/div[1]/section[2]/div/div/div/div/form/div[1]/div[1]/input").send_keys("Student")
    ...
    driver.find_element(By.XPATH, "/html/body/div/div[1]/section[2]/div/div/div/div/form/div[1]/div[6]/input").send_keys("C:/Users/AdnanAsad/OneDrive/Desktop/University Portal/media/images (1).png")
    ...
    driver.find_element(By.XPATH, "/html/body/div/div[1]/section[2]/div/div/div/div/form/div[1]/div[9]/select/option[2]").click()
